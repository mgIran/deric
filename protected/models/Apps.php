...
class Apps extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('description, change_log, permissions ,developer_team ,_purifier, categoryForm', 'safe'),
     ...
     * @return string
     */
    public function getDownloadUrl($data= false)
    {
        return Yii::app()->createAbsoluteUrl('/apps/download/' . CHtml::encode($this->id)).($data?'?data=true':'');
    }
