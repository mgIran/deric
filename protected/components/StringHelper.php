...
class StringHelper
{
    ...
    {
        if ($asHtml) {
            return static::truncateHtml($string, $length, $suffix, $encoding ?: self::$charset);
        }

        if (mb_strlen($string, $encoding ?: self::$charset) > $length) {
            return rtrim(mb_substr($string, 0, $length, $encoding ?: self::$charset)) . $suffix;
        } else {
            return $string;
        }
    }
    ...
    public static function startsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, 0, $bytes, '8bit'), self::$charset) === mb_strtolower($with, self::$charset);
        }
    }
    ...
    public static function endsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, -$bytes, mb_strlen($string, '8bit'), '8bit'), self::$charset) === mb_strtolower($with, self::$charset);
        }
    }
